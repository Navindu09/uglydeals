...
public class MultiSpinner extends AppCompatTextView {
    ...
    public void setAdapterWithOutImage(Context context, List<String> spinnerContentList, List<String> checkedList, MultiSelectionSpinnerDialog.OnMultiSpinnerSelectionListener onMultiSpinnerSelectionListener) {
        MultiSelectionSpinnerDialog multiSelectionSpinnerDialog = new MultiSelectionSpinnerDialog(context);
        multiSelectionSpinnerDialog.setMultiSelectionAdapterWithOutImage(context, spinnerContentList, checkedList, onMultiSpinnerSelectionListener);
    }
    ...
    public void setCheckdItem(int i) {
