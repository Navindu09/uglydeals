...
public class FeaturedItemActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_featured_item);
       ...
       /* buttonSelectedItemRedeem.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (ContextCompat.checkSelfPermission(FeaturedItemActivity.this, Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED) {
                    ActivityCompat.requestPermissions(FeaturedItemActivity.this, new String[]{Manifest.permission.CAMERA}, PERMISSION_REQUEST);


                } else {
                    Intent scanIntent = new Intent(FeaturedItemActivity.this, ScanActivity.class);
