...
public class FeaturedDealRecyclerAdapter extends RecyclerView.Adapter<FeaturedDealRecyclerAdapter.ViewHolder>
{
    ...
    @NonNull
    @Override
    public FeaturedDealRecyclerAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
    ...
    @Override
    public void onBindViewHolder(@NonNull final FeaturedDealRecyclerAdapter.ViewHolder viewHolder, int i) {
